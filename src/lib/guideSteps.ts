...
export const LEAD_GUIDE_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    title: "결과 분석",
    caption:
      "응답을 받은 뒤 가운데 탭의 결과 분석 · 내보내기로 갑니다. 대상별 응답 엑셀을 올리세요. 학년말 응답만 씁니다. 중간평가 때 받은 파일은 쓰지 마세요.",
  ...
  },
  {
    ...
    title: "제출 서류",
    caption:
      "평가지표 및 현황(XLSX), 설문 결과 보고서(HTML), 학교평가서(DOCX)는 학년말에서만 만들어집니다. 중간평가 결과로는 학교평가서를 만들지 않습니다. (가이드북 Q12)"
  },
  {
    id: "stuck",
    title: "막혔을 때",
